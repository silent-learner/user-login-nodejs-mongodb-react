...
class Dashboard extends Component {
   ...
   render() { 
      ...
      <div className="container signup-form" style={{backgroundColor:"white", color: "black", padding:"20px", borderRadius:"5px"}}>    
      <h1>User Profile</h1>     
         ...
         <div className="form-row">
            <div className="form-group col-md-12"> 
            First Name:<label className="form-control"> {this.props.user.firstname}</label>
             Last Name: <label className='form-control'>{this.props.user.lastname}</label>
            </div>            
         </div>
         <div className="form-row">
            <div className="form-group col-md-12"> 
