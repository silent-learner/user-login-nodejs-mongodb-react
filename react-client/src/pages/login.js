...
class LogIn extends React.Component {
   ...
   render() { 
      ...
      <div className="signup-form" style={{backgroundColor:"white", color: "black", height:"400px", padding:"20px", borderRadius:"5px", width: "350px"}}>    
         ...
         <div className="form-group">               
            <input type="submit" value="LogIn" onClick={this.handleLoginClick} className="btn btn-primary" /> &nbsp;&nbsp; Don't have account? <Link className="btn btn-outline-primary" to="/signup"><b>Sign Up</b></Link>
         </div>   
         <div className="form-group">  
